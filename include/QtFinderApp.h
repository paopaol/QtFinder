...
public:
  ...
  virtual void selectCandidateAsPath(int row) = 0;
...
public:
  ...
  virtual void openDirectoryOfFile(const QString &path) = 0;
  virtual void openDirectoryOrFile(const QString &path) = 0;
};
